...
void SQL::Connect()
{
	switch (SQLDriverConnect(SQLConnHandle, NULL, (SQLCHAR*)"SERVER=192.168.8.189,1433;DSN=JoelDB;UID=myID2;PWD=myPW2;WSID=JE-ACCOUNTS;DATABASE=myDB;", SQL_NTS, NULL, 1024, NULL, SQL_DRIVER_NOPROMPT))
	{
	case SQL_SUCCESS:
